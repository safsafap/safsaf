...
class FornisseurProductItem extends StatelessWidget {
  ProductFornisseurModel product;
  bool loading;
  FornisseurProductItem({super.key, required this.product, this.loading = false});
